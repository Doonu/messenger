...
export const notificationLoadingSelectors = (state: RootState) => state.notificationSlice.isLoading;
export const notificationErrorSelectors = (state: RootState) => state.notificationSlice.isError;
export const notificationLimitSelectors = (state: RootState) => state.notificationSlice.limit;
export const notificationHaseMoreSelectors = (state: RootState) =>
  state.notificationSlice.isHaseMore;
